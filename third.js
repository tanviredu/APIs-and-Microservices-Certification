...
var createAndSavePerson = function(done) {
  var Tanvir = new Person({
    name:"Tanvir",
    age: 27,
    favoriteFoods:['biriyani','icecream']
  })
  Tanvir.save((err,data)=>{
    if(err){
      console.log(err)
    }
     done(null,data);   
...
//Person.create is used for injecting many data all at once
// for seedng data
